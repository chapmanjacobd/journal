...
def _expand_backup_suffix(backup_suffix):
    return (
        backup_suffix.replace(TIMESTAMP_VAR, new_timestamped_uid()) if TIMESTAMP_VAR in backup_suffix else backup_suffix
    )
...
def temp_output_file(prefix="tmp", suffix="", dir=None, make_parents=False, always_clean=False):
    ...
    """
    return _temp_output(
        False, prefix=prefix, suffix=suffix, dir=dir, make_parents=make_parents, always_clean=always_clean
    )
...
def temp_output_dir(prefix="tmp", suffix="", dir=None, make_parents=False, always_clean=False):
    ...
    """
    return _temp_output(
        True, prefix=prefix, suffix=suffix, dir=dir, make_parents=make_parents, always_clean=always_clean
    )
