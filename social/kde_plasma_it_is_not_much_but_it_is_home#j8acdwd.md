...
I'm using this: https://github.com/dexpota/kitty-themes#novel
but I'm using `#d4ccb9` instead of `#dfdbc3` for `background`

I use a similar [browser userstyle](https://userstyles.world/style/8201/global-lightbg-desert-sepia-medium-contrast) and [VS Code](https://github.com/chapmanjacobd/computer/blob/main/.github/vscode_theme_medium-contrast.jsonc).

I think this might be the default but I don't remember:
